const TermsAndConditions = () => {
  return (
    <div className="p-3 m-1">
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to DELBITE, 1/128 OPPOSITE AP TRANSCO,GOOTY
            RAS,515402.
          </p>
        </li>
        <li>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to DELBITE, accessible from{" "}
            <a
              href="www.delbite.com"
      ...
      <ul>
        <li>By email: contact@delbite.com</li>
      </ul>
    </div>
  );
};
