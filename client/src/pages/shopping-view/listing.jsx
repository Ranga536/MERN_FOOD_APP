...
//session storage used to store filters and user location
// import ProductFilter from "@/components/shopping-view/filter";
// import { filterOptions } from "@/config";
// import FooterInfo from "@/components/shopping-view/footer";
// import ShoppingProductTile from "@/components/shopping-view/product-tile";
...
//   // Ask for location and store in session
//   const handleGetLocation = () => {
//     if (!navigator.geolocation) {
...
//   // On mount, get location from session or request
//   useEffect(() => {
...
//           {/* Show location error + retry button */}
//           {locationError && (
//             <div className="text-center font-semibold bg-white rounded-lg shadow-md m-5 p-6 text-red-600">
//               📍 {locationError}
//               <br />
